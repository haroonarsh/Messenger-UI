// base url
export const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || 'https://messenger-backend-f3fy.onrender.com/api';
...
export const SOCKET_URL = process.env.NEXT_PUBLIC_SOCKET_URL || 'https://messenger-backend-f3fy.onrender.com';
...
export const API_GET_FRIENDS = `${API_BASE_URL}/user/friends`;