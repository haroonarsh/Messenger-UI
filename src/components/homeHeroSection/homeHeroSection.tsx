            ...
            <div className="flex w-[100%] flex-col md:flex-row items-center justify-between gap-3 ">
              ...
              <div className="space-y-6 text-start md:text-left w-full lg:w-[80%]">
                ...
                <div className='flex items-baseline justify-between w-full md:w-80 space-x-2'>
                    <button type="submit" className="bg-blue-600 text-white px-5 py-2 rounded-full hover:bg-blue-700 transition duration-200 text-xl font-medium font-sans cursor-pointer">
                        Log In
                    </button>
                    <a href="#" className="text-blue-600 text-md font-medium font-sans transition duration-200 border-b-[2px] border-transparent hover:border-blue-600">Forgotten your password?</a>
                </div>
                <div>
