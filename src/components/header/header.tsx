...
function Header() {
  ...
  return (
    <>
      ...
      <div className='hidden md:flex fixed top-25 max-w-[94%] mx-auto bg-white xl:px-10 py-4 z-50 font-sans'>
      ...
      <div className={`fixed top-25 py-4 left-0 bg-white w-full md:hidden ${isMenuOpen ? 'block border-t-[1px]' : 'hidden'} shadow-lg z-50`}>
          ...
          <li className={`w-full flex flex-col gap-2 ${isFeatureMenuOpen ? 'block' : 'hidden'}`}>
            <span className='flex items-center justify-between p-4 md:hidden cursor-pointer w-full bg-[#f4f9fe] border-b-[3.5px] border-transparent hover:border-[#0a7cff] text-2xl font-semibold font-sans'>Useful <FaArrowRightLong className='text-[#0a7cff] h-5 w-5' /></span>
            <span className='flex items-center justify-between p-4 md:hidden cursor-pointer w-full bg-[#f4f9fe] border-b-[3.5px] border-transparent hover:border-[#0a7cff] text-2xl font-semibold font-sans'>Social <FaArrowRightLong className='text-[#0a7cff] h-5 w-5' /></span>
            <span className='flex items-center justify-between p-4 md:hidden cursor-pointer w-full bg-[#f4f9fe] border-b-[3.5px] border-transparent hover:border-[#0a7cff] text-2xl font-semibold font-sans'>Expressive <FaArrowRightLong className='text-[#0a7cff] h-5 w-5' /></span>
          </li>
