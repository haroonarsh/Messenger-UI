import { API_ACCEPT_FRIEND_REQUEST, API_GET_FRIENDS, API_GET_PENDING_REQUESTS, API_REJECT_FRIEND_REQUEST, API_SEARCH_USERS, API_SEND_FRIEND_REQUEST } from "@/libs/api";
